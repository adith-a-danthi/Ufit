...
require_once '../inc/process_membership.php'
?>
    ...
    <div class="card-body">
        <form action="membership.php" method="post">
            <div class="row mx-auto" style="padding: 10px">
                ...
                <div class="col md-6" style="padding: 10px;margin-left: 20px">
                    <br>
                    <button class="btn btn-outline-dark" type="button" id="calc-fees" onclick="calculateFees()">
                        Calculate Fees
                    </button>
                </div>
            </div>
            ...
            <button class="btn btn-outline-dark" type="submit" id="btn-confirm" disabled>Confirm</button>
    </div>
    </form>
</div>
